...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    age_targets: Schema.Attribute.Component<'shared.age-target', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    program_gallery_item: Schema.Attribute.Component<
      'shared.program-gallery-item',
      true
    >;
    program_name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    segment: Schema.Attribute.Enumeration<
      ['monthly', 'foundation', 'private', 'event']
    >;
